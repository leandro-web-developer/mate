<H1 class='pb-3 text-white' id='faqs'>FAQs - Preguntas frecuentes</H1>
...
<div id="accordion">
    <div class="card">
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
                Ninguna de las noticias, artículos y demás contenidos que figuran en este sitio son escritos, editados o
                creados de alguna forma por nuestro equipo y le pertenecen 100% a sus respectivos portales (a los que siempre
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
            <div class="card-body">
                ...
                <p>El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en
                    ...
                    alguno de nuestros productos. mal.uy no asume la responsabilidad en caso de que entregue dicha
                    clave a terceros.</p>
                ...
                <p>mal.uy&nbsp; a través de su sitio web concede una licencia para que los usuarios utilicen&nbsp;
                ...
                <p>Este mal.uy garantiza que la información personal que usted envía cuenta
                    con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una
                ...
                <p>mal.uy reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>

                <p><strong>POLÍTICA DE PRIVACIDAD</strong></p>
                        <p>El presente Política de Privacidad establece los términos en que mal.uy usa y protege la
                        ...
                        <p>mal.uy está altamente comprometido para cumplir con el compromiso de mantener su información
                        ...
                        <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su
                            ...
                            usted así lo quiera y la proporcione directamente noticias. Usted puede aceptar o negar el uso de cookies, sin embargo la
                        ...
                        <p>Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés. Una vez
                            ...
                            sitio al que es redirigido y por lo tanto no somos responsables de los términos o
                        ...
                        <p>mal.uy Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en
                            cualquier momento.</p>
            </div>
        </div>
    </div>
